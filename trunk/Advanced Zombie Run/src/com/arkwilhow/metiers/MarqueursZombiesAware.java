...
public class MarqueursZombiesAware extends ItemizedOverlay {

	private ArrayList<Zombie> listeMarqueur = new ArrayList<Zombie>();
	private Context mContext;

	public MarqueursZombiesAware(Drawable defaultMarker) {
		super(boundCenterBottom(defaultMarker));
	}

	public MarqueursZombiesAware(Drawable defaultMarker, Context context) {
		super(boundCenterBottom(defaultMarker));
		mContext = context;
	}
